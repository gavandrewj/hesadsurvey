...
#q0-1
surveydataset[surveydataset$q0_1oth == 'Barimanobo' & is.na(surveydataset$q0_1oth) == F ,'q0_1'] <- '34'
surveydataset[surveydataset$q0_1oth == 'Barimanobo' & is.na(surveydataset$q0_1oth) == F,'q0_1oth'] <- ''

surveydataset[surveydataset$q0_1oth == 'Manawarin' & is.na(surveydataset$q0_1oth) == F,'q0_1'] <- '26'
surveydataset[surveydataset$q0_1oth == 'Manawarin' & is.na(surveydataset$q0_1oth) == F,'q0_1oth'] <- ''

surveydataset[surveydataset$q0_1oth == 'Wauana & Settlement' & is.na(surveydataset$q0_1oth) == F,'q0_1'] <- '35'
surveydataset[surveydataset$q0_1oth == 'Wauana & Settlement' & is.na(surveydataset$q0_1oth) == F,'q0_1oth'] <- ''
...
# ##
# 
#q0-5 surveydataset$q0_5oth == '' & is.na(surveydataset$q0_5oth) == F |

surveydataset[surveydataset$q0_5oth == 'the phone signal is very poor and they still cannot hear if they "hang" (higher) the phone up' & is.na(surveydataset$q0_5oth) == F |
              surveydataset$q0_5oth == 'CALL DROPPED' & is.na(surveydataset$q0_5oth) == F |
              surveydataset$q0_5oth == 'Interview discontinued because of very bad connectivity' & is.na(surveydataset$q0_5oth) == F | 
              surveydataset$q0_5oth == 'VERY POOR SIGNAL' & is.na(surveydataset$q0_5oth) == F ,'q0_5'] <- '13'

surveydataset[surveydataset$q0_5oth == 'the phone signal is very poor and they still cannot hear if they "hang" (higher) the phone up' & is.na(surveydataset$q0_5oth) == F |
                surveydataset$q0_5oth == 'CALL DROPPED' & is.na(surveydataset$q0_5oth) == F |
                surveydataset$q0_5oth == 'Interview discontinued because of very bad connectivity' & is.na(surveydataset$q0_5oth) == F | 
                surveydataset$q0_5oth == 'VERY POOR SIGNAL' & is.na(surveydataset$q0_5oth) == F ,'q0_5oth'] <- ''

surveydataset$q0_5oth <- tolower(surveydataset$q0_5oth)

surveydataset[surveydataset$q0_5oth == 'number switched off or out of service area' & is.na(surveydataset$q0_5oth) == F |
              surveydataset$q0_5oth == 'phone is off' & is.na(surveydataset$q0_5oth) == F |
              surveydataset$q0_5oth == 'restricted number' & is.na(surveydataset$q0_5oth) == F  ,'q0_5'] <- '4'

surveydataset[surveydataset$q0_5oth == 'number switched off or out of service area' & is.na(surveydataset$q0_5oth) == F |
                surveydataset$q0_5oth == 'phone is off' & is.na(surveydataset$q0_5oth) == F |
                surveydataset$q0_5oth == 'restricted number' & is.na(surveydataset$q0_5oth) == F  ,'q0_5oth'] <- ''



surveydataset[grep('.*voicemail.*',surveydataset$q0_5oth),'q0_5'] <- '3'
surveydataset[grep('.*voicemail.*',surveydataset$q0_5oth),'q0_5oth'] <- ''

# surveydataset[grep('.*complete.*',surveydataset$q0_5oth),'q0_5'] <- '3'
# surveydataset[grep('.*complete.*',surveydataset$q0_5oth),'q0_5oth'] <- ''

surveydataset[surveydataset$q0_5oth == 'person does not reside in the target area for data collection.' & is.na(surveydataset$q0_5oth) == F |
              surveydataset$q0_5oth == 'person lives in wortmanville georgetown' & is.na(surveydataset$q0_5oth) == F   ,'q0_5'] <- '14'

surveydataset[surveydataset$q0_5oth == 'person does not reside in the target area for data collection.' & is.na(surveydataset$q0_5oth) == F |
              surveydataset$q0_5oth == 'person lives in wortmanville georgetown' & is.na(surveydataset$q0_5oth) == F   ,'q0_5oth'] <- ''


surveydataset[surveydataset$q0_5oth == 'respondent kept cutting the phone off' & is.na(surveydataset$q0_5oth) == F ,'q0_5'] <- '2'
surveydataset[surveydataset$q0_5oth == 'respondent kept cutting the phone off' & is.na(surveydataset$q0_5oth) == F ,'q0_5oth'] <- ''
...
surveydataset$q0_5 <- factor(surveydataset$q0_5,
                             ...
                             labels = c(
                               ...
                               'Person does not live in target area'
                             ))
...
surveydataset$q0_5oth <- trimws(surveydataset$q0_5oth)
# 
# filter out non response
nonresponsesurveydataset <- dplyr::filter(surveydataset,q0_5 != 'Respondent agreed to participate in the survey')
surveydataset <- dplyr::filter(surveydataset,q0_5 == 'Respondent agreed to participate in the survey')
...
# 
##p1 - p20
varnames <- paste('p',1:20,sep = '')

for(var in varnames){
surveydataset[[var]] <- tolower(surveydataset[[var]])  
}
...
for(i in 1:nrow(surveydataset)){
  numselected <- surveydataset$q1_0[i]
  numtonotselect <- numselected + 1
  vartonotselect <- paste('p',numtonotselect:20,sep = '')
  
  for(var in vartonotselect){
    surveydataset[[var]][i] <- 'Not Selected'
  }
